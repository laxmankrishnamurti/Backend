...
async function createUser(req, res){
    ...
    if(!userPayload.first_name || !userPayload.last_name || !userPayload.email || !userPayload.gender || !userPayload.job_title){
...
async function updateUser(req, res){
    ...
    const updatedUser = await User.findOneAndUpdate({email: userPayload.email}, {...userPayload})
...
module.exports = {getAllUsers, getUserById, createUser, updateUser, deleteUser, deleteById}